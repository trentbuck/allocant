...
def main():
    with (contextlib.closing(MySQLdb.connect(db='alloc')) as conn,
        ...
        dst.executemany('INSERT INTO product (productID, productName, sellPrice, sellPriceCurrencyTypeID, sellPriceIncTax, description, comment, productActive) VALUES (:productID, :productName, :sellPrice, :sellPriceCurrencyTypeID, :sellPriceIncTax, :description, :comment, :productActive)', src)
